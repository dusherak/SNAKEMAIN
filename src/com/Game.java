...
public class Game extends JPanel {
    ...
    private void loadImages() {
        ...
        //head facing right image
        ImageIcon iihr = new ImageIcon("src/resources/headR.png");
        headR = iihr.getImage();

        //head facing left image
        ImageIcon iihl = new ImageIcon("src/resources/headL.png");
        headL = iihl.getImage();

        //head facing down image
        ImageIcon iihd = new ImageIcon("src/resources/headD.png");
        headD = iihd.getImage();

        //head facing right image
        ImageIcon iihu = new ImageIcon("src/resources/headU.png");
        headU = iihu.getImage();
    }
    ...
    private void render(Graphics g) {
        ...
        if (cherry != null) {
            if (didLoadCherryImage) {
                ...
                g2d.fillRect(cherry.getX(), cherry.getY(), 10, 10);
                g2d.setColor(new Color(53, 220, 8));
            }
        }
